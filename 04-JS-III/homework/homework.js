...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
 let encontrarElemento = array.includes (elemento);
...
function promedioResultadosTest(resultadosTest) {
  // "resultadosTest" debe ser 
  //una matriz de enteros (int/integers)
...
function numeroMasGrande(numeros) {
  // "numeros" debe ser una matriz 
  //de enteros (int/integers)
  // Devuelve el número más grande
  // Tu código:
  numeroMayor= Math.max.apply(null, numeros);
return numeroMayor;
}
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let mayores18 = arreglo.filter (element => element > 19 );
  return mayores18.length;
}


function diaDeLaSemana(numeroDeDia) {
  //Suponga que los días de la semana 
  //se codifican como 1 = Domingo, 2 = Lunes 
  //y así sucesivamente. 
  //Realiza una función que dado el número 
  //del día de la semana, retorne: Es fin de semana
...
function empiezaConNueve(n) {
  //Desarrolle una función que recibe como
  // parámetro un número entero n. Debe retornar
  // true si el entero 
...
for (let i = 0; i< 10; i++){
  if (i=== 5) {
    ...
    numero = numero + 2;
    nuevoarrayContinue.push(numero);
  }
